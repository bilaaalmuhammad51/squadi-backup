...
describe("Authentication - Invalid Login Flow with invalid credentials", () => {
    ...
    it("should display an error message for invalid login credential combinations", async () => {
        ...
        // ---------- Case 1 ----------
        await step("Validate error for unregistered email with valid password", async () => {
        ...
        // ---------- Case 2 ----------
        await step("Validate error for valid email with invalid password", async () => {
        ...
        // ---------- Case 3 ----------
        await step("Validate error for invalid email with valid password", async () => {
        ...
        // ---------- Case 4 ----------
        await step("Validate error for both email and password invalid", async () => {
